...
func (uc *UserCreate) SetJwtTokenKey(s string) *UserCreate {
	uc.mutation.SetJwtTokenKey(s)
	return uc
}

// SetNillableJwtTokenKey sets the "jwt_token_key" field if the given value is not nil.
func (uc *UserCreate) SetNillableJwtTokenKey(s *string) *UserCreate {
	if s != nil {
		uc.SetJwtTokenKey(*s)
	}
	return uc
...
func (uc *UserCreate) defaults() {
	...
	if _, ok := uc.mutation.JwtTokenKey(); !ok {
		v := user.DefaultJwtTokenKey()
		uc.mutation.SetJwtTokenKey(v)
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.JwtTokenKey(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
